...
public class WookiModule<T>
{
    ...
    {
	CoercionTuple<String, ActivityType> tuple = new CoercionTuple<String, ActivityType>(String.class, ActivityType.class, StringToEnumCoercion.create(ActivityType.class));

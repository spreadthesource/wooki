...
public interface LinkSupport
{
    ...
    /**
     * Create and append a new menu item. This item is used to link to another page.
     * 
     * @param type
     * @param name
     * @param pageName
     * @param pageActivationContext
     * @return The corresponding BookItem that can be filled with confirm message if needed.
     */
    BookMenuItem createPageMenuItem(LinkType type, String name, String pageName,
     ...
     * @return The corresponding BookItem that can be filled with confirm message if needed.
     */
    BookMenuItem createEventMenuItem(LinkType type, String name, String pageName, String eventType,
            Object... context);
     ...
     * @return The corresponding BookItem that can be filled with confirm message if needed.
     */
    BookMenuItem createEventMenuItem(LinkType type, String name, String pageName, String nestedId,
            String eventType, Object... context);

    BookMenuItem createNavLink(NavLinkPosition position, String name, String pageName,
            Object... context);

    /**
     * Commit the links element into the resulting markup. After a call to this method Menu will be
     * created.
     * 
     * @param writer
     */

...
public class AccountActivityFeed extends AbstractActivityFeed<AccountActivity> {
	...
	public String getTitle(AccountActivity activity) {
		return messages.getMessages().format(getKeyForTitle(activity.getType().toString()), activity.getUser().getUsername(), activity.getUser().getFullname());
	}

	public String getSummary(AccountActivity activity) {
		return messages.getMessages().format(getKeyForSummary(activity.getType().toString()), activity.getUser().getUsername(),

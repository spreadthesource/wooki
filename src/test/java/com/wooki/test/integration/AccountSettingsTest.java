...
public class AccountSettingsTest extends AbstractWookiIntegrationTestSuite
{
    ...
    public void testUpdatePasswordFailure()
    {
        ...
        waitForPageToLoad();
        Assert.assertTrue(
                isTextPresent("Your old password is incorrect"),
                "An error message should be displayed with incorrect old password.");
    ...
    public void testUpdatePasswordSuccess()
    {
        ...
        waitForPageToLoad();
        Assert.assertTrue(
                isTextPresent("Your password has been updated"),
                "An flash message should be displayed to inform password change success.");

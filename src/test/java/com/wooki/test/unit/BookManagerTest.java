...
public class BookManagerTest extends AbstractTransactionalTestNGSpringContextTests
{
    ...
    public void testChapterPreviousAndNext()
    {
        ...
        Object[] result = chapterManager.findPrevious(myProduct.getId(), myProduct.getChapters()
                .get(1).getId());
        ...
        result = chapterManager.findPrevious(myProduct.getId(), myProduct.getChapters().get(0)
                .getId());
        Assert.assertNull(result);
        ...
        result = chapterManager.findPrevious(myProduct.getId(), myProduct.getChapters().get(2)
                .getId());
        Assert.assertNotNull(result);
        Assert.assertEquals(result.length, 2);
        Assert.assertEquals("Requirements", result[1]);
    ...
    public void testPublication()
    {
        ...
        chapterManager.updateAndPublishContent(chapters.get(0).getId(), new String(
                "<p>Tapestry is totally amazing éàê</p>"));

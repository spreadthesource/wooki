...
/**
 * This exception is thrown when the an error occurs during publication process.
 * In case of publication exception, the document must be saved but not published. 
 *
 * @author ccordenier
 *
 */
